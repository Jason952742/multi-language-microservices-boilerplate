...
It allows you to analyze any data set by using the searching/aggregation capabilities of Elasticsearch and
...
> [!WARNING]
> Starting with Elastic v8.0.0, it is no longer possible to run Kibana using the bootstrap privileged `elastic` user.
