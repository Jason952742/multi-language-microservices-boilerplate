...
import org.shared.common.resource.JasResult
...
open class JasResourceBase {
    ...
    class ErrorMapper : ExceptionMapper<Exception> {
        ...
        override fun toResponse(exception: Exception): Response {
            org.shared.common.base.JasResourceBase.Companion.LOG.error("Failed to handle request", exception)
    ...
    companion object {
        private val LOG = Logger.getLogger(org.shared.common.base.JasResourceBase::class.java.name)
    }
}
